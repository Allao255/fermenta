...
% ---------------- configuration ----------------
netlist = 'DOD';        % try 'MXR' (one_non_lin_opamp) or 'DOD' (non_lin_opamp)
outNode = 'N009';       % MXR -> N010 ; DOD -> N009
code    = 'DODtest';    % a valid MATLAB identifier for the generated class
fs      = 48000;
dur     = 0.05;
